...
export type CreatSubscriberMutationVariables = Exact<{
  name: Scalars['String'];
  email: Scalars['String'];
}>;


export type CreatSubscriberMutation = { __typename?: 'Mutation', createSubscriber?: { __typename?: 'Subscriber', id: string } | null };
...
export const CreatSubscriberDocument = gql`
  ...
  createSubscriber(data: {name: $name, email: $email}) {
    ...
    `;
export type CreatSubscriberMutationFn = Apollo.MutationFunction<CreatSubscriberMutation, CreatSubscriberMutationVariables>;

/**
 * __useCreatSubscriberMutation__
 *
 * To run a mutation, you first call `useCreatSubscriberMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useCreatSubscriberMutation` returns a tuple that includes:
 ...
 *
 * @example
 * const [creatSubscriberMutation, { data, loading, error }] = useCreatSubscriberMutation({
 *   variables: {
 *      name: // value for 'name'
 ...
 * });
 */
export function useCreatSubscriberMutation(baseOptions?: Apollo.MutationHookOptions<CreatSubscriberMutation, CreatSubscriberMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<CreatSubscriberMutation, CreatSubscriberMutationVariables>(CreatSubscriberDocument, options);
      }
export type CreatSubscriberMutationHookResult = ReturnType<typeof useCreatSubscriberMutation>;
export type CreatSubscriberMutationResult = Apollo.MutationResult<CreatSubscriberMutation>;
export type CreatSubscriberMutationOptions = Apollo.BaseMutationOptions<CreatSubscriberMutation, CreatSubscriberMutationVariables>;
